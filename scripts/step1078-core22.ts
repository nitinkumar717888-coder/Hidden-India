...
export const RESEARCHED_20_DESTINATIONS: ResearchedDestinationData[] = [
    ...
    images: [
      {
        ...
        caption: 'The imposing Kushan-era brick bastions of Qila Mubarak, standing over 30 meters high.',
        credit: 'Hidden India Archive',
        license: 'Editorial Heritage License',
        isPrimary: true,
      },
    ],
  },
    ...
    images: [
      {
        ...
        caption: 'The arched gateway and lakhori brick masonry of the 16th-century Buria compound.',
        credit: 'Hidden India Archive',
    ...
    images: [
      {
        ...
        caption: 'The medieval stone baradari standing atop the isolated volcanic outcrop of Tosham Hill.',
        credit: 'Hidden India Field Archive',
    ...
    images: [
      {
        ...
        caption: 'The white marble dome of Sheikh Chehli’s tomb rising over the manicured Mughal gardens in Thanesar.',
        credit: 'Hidden India Archive',
        license: 'Editorial Heritage License',
        isPrimary: true,
      },
  ...
  // 5. Jal Mahal & Chor Gumbad, Narnaul
  {
    name: 'Jal Mahal & Chor Gumbad of Narnaul',
    slug: 'jal-mahal-chor-gumbad-narnaul',
    shortDescription: 'A 1591 CE water palace rising out of an expansive reservoir and an enigmatic Afghan watchtower dubbed the ‘Signpost of Narnaul’.',
    longDescription: 'Narnaul, an ancient frontier town in the foothills of the Aravalli range, served as a major regional mint and administrative center under the Suri and Mughal dynasties. Built in 1591 CE by Shah Quli Khan—Akbar’s trusted governor who captured the Suri general Hemu at the Second Battle of Panipat—the Jal Mahal is an exquisite square pleasure pavilion rising dramatically from the center of a massive stone-lined reservoir known as Khan Sarovar. Visitors access the central pavilion via an arched stone causeway leading to a double-storeyed structure adorned with cupolas and painted vaulted ceilings. A short distance away stands Chor Gumbad, a brooding 14th-century square Afghan tomb with four arched corner bastions that earned its nickname as a hideout for highwaymen operating along the ancient Delhi-Rajputana caravan route.',
    state: 'Haryana',
    ...
    historicalPeriod: 'Mughal Era (1591 CE) and Afghan Period (14th Century CE)',
    difficulty: 'easy',
    estimatedVisitDuration: '2 to 3 hours',
    evidenceClassification: 'DOCUMENTED',
    editorialStatus: 'published',
    isFeatured: false,
    categorySlugs: ['historical', 'architecture', 'monuments', 'forts'],
    sources: [
      {
      ...
      },
      {
        ...
        notes: 'Documentation of Narnaul’s stepwells, pleasure palaces, and Afghan watchtowers.',
      },
    ],
    visitInfo: {
    ...
    evidenceItems: [
      ...
      },
      {
        ...
        content: 'Local accounts maintain that 18th-century outlaws utilized the upper hidden chambers of Chor Gumbad as a lookout to ambush spice caravans, giving it its enduring folk name.',
        classification: 'LOCAL_TRADITION',
        citationNotes: 'Recorded in Mahendragarh District Gazetteer folklore chapter.',
        displayOrder: 2,
      },
    ],
    images: [
      {
        ...
        altText: 'Stone water palace connected by long bridge over water reservoir',
        caption: 'The 1591 CE Jal Mahal rising in the center of the historic Khan Sarovar in Narnaul.',
        credit: 'Hidden India Field Archive',
    ...
    images: [
      {
        ...
        caption: 'The Tughlaq-era masonry and fortified gateway of Kotla in the Aravalli hills.',
        credit: 'Hidden India Field Archive',
    ...
    images: [
      {
        ...
        caption: 'The monolithic stone shikharas of Masrur reflecting in the sacred mountain reservoir.',
        credit: 'Hidden India Archive',
        license: 'Editorial Heritage License',
        isPrimary: true,
      },
    ...
    images: [
      {
        ...
        caption: 'The ancient monk retreat caves hollowed into the sheer siltstone cliffs above Tabo in Spiti.',
        credit: 'Hidden India Field Archive',
        license: 'Creative Commons CC-BY 4.0',
        isPrimary: true,
      },
    ...
    images: [
      {
        ...
        caption: 'The cliff road ledge blasted into sheer granite cliffs high above the Chenab gorge.',
        credit: 'Hidden India Archive',
  ...
  // 10. Gondhla Tower Fort, Lahaul
  {
    ...
    visitInfo: {
      entryFee: '₹50 per person (Village heritage preservation fund)',
      currency: 'INR',
      feeType: 'per_person',
      isFeeVerified: true,
    ...
    images: [
      {
        ...
        caption: 'The eight-storey timber-laced tower of Gondhla Fort in the Chandra Valley of Lahaul.',
        credit: 'Hidden India Archive',
        license: 'CC-BY-SA 4.0',
        isPrimary: true,
      },
    ...
    images: [
      {
        ...
        caption: 'The cobblestone lanes and preserved historic havelis of Pragpur Heritage Village.',
        credit: 'Hidden India Archive',
        license: 'Editorial Heritage License',
        isPrimary: true,
      },
    ...
    images: [
      {
        ...
        caption: 'The historical Mughal pavilions and hydraulic channels of Aam Khas Bagh in Sirhind.',
        credit: 'Hidden India Archive',
        license: 'Editorial Heritage License',
        isPrimary: true,
      },
    ...
    images: [
      {
        ...
        caption: 'The monumental gateway of Mughal Sarai Doraha along the historic Grand Trunk Road.',
        credit: 'Hidden India Field Archive',
        license: 'CC-BY 4.0',
        isPrimary: true,
      },
    ...
    images: [
      {
        ...
        caption: 'The Indo-Saracenic facade of the Faridkot royal palace complex.',
        credit: 'Hidden India Archive',
        license: 'Editorial Heritage License',
        isPrimary: true,
      },
    ...
    images: [
      {
        ...
        caption: 'The surviving 18th-century defensive brick bastion of Burail Fort in Sector 45, Chandigarh.',
        credit: 'Hidden India Field Archive',
        license: 'CC-BY 4.0',
        isPrimary: true,
      },
    ...
    images: [
      {
        ...
        caption: 'The 8th-century Gurjara-Pratihara sculptural ruins at the Bhima Devi Temple complex in Pinjore.',
        credit: 'Hidden India Archive',
        license: 'Editorial Heritage License',
        isPrimary: true,
      },
  ...
  // 17. Kalesar Colonial Red Iron Bridge & Dak Bungalow
  {
    name: 'Kalesar Colonial Red Iron Bridge & Dak Bungalow',
    slug: 'kalesar-colonial-bridge-dak-bungalow',
    shortDescription: 'A historic 1880s British colonial forestry outpost and red iron suspension river crossing on the Yamuna foothills.',
    longDescription: 'Standing at the strategic confluence where the Yamuna River exits the Himalayan foothills into the plains of Haryana and Uttar Pradesh, the Kalesar forest precinct retains rare architectural relics of late-Victorian colonial forestry administration. The historic Kalesar Red Iron Suspension Bridge was constructed in the 1880s to facilitate timber transport and river inspection. Perched on a nearby ridge overlooking the river sits the 1890s colonial Dak Bungalow, featuring deep wrap-around timber verandas, high ceilings with punkah hooks, and antique iron fireplaces, surrounded by one of the largest contiguous sal (Shorea robusta) forests in the Shiwalik foothills.',
    state: 'Haryana',
    district: 'Yamunanagar',
    locality: 'Kalesar National Park Buffer',
    latitude: 30.3472,
    longitude: 77.5806,
    coordinateSource: 'Haryana Forest Department Historical Register & GPS',
    historicalPeriod: 'British Colonial Forestry Era (ca. 1880–1900 CE)',
    difficulty: 'easy',
    estimatedVisitDuration: '2 hours',
    evidenceClassification: 'DOCUMENTED',
    editorialStatus: 'published',
    ...
    sources: [
      {
        ...
        notes: 'Detailed maps and engineering records of the Yamuna timber booms and inspection bungalows.',
      },
    ],
    visitInfo: {
      entryFee: '₹50 per person for entry to the forest heritage zone',
      currency: 'INR',
      feeType: 'per_person',
      isFeeVerified: true,
      openingInformation: '07:00 to 17:00 daily (Closed during heavy monsoon rains)',
      parkingInformation: 'Designated parking bay near forest checkpost',
      accessInformation: 'Smooth state highway from Paonta Sahib (15 km) or Yamunanagar (45 km).',
      bestTimeInformation: 'November to March for cool weather and migratory bird sightings.',
    },
    evidenceItems: [
      {
        sectionTitle: 'Colonial Timber Extraction Records',
        content: 'Forest working plans verify the bridge and bungalow were established following the 1878 Indian Forest Act to control sal timber floating rights on the Yamuna.',
        classification: 'DOCUMENTED',
    ...
    images: [
      {
        imageUrl: 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=1200&q=80',
        altText: 'Red iron bridge spanning wide river bed with forested hills in background',
        caption: 'The 1880s colonial red iron bridge crossing the Yamuna at the entrance to Kalesar forest.',
        credit: 'Hidden India Archive',
        license: 'Editorial License',
        isPrimary: true,
      },
    ...
    images: [
      {
        ...
        caption: 'The imposing 3rd-century mud-brick ramparts of Bhatner Fort overlooking the ancient Ghaggar riverbed.',
        credit: 'Hidden India Archive',
        license: 'Editorial Heritage License',
        isPrimary: true,
      },
  ...
  // 19. Bassi Baoli & Stepwells of Pinjore-Kalka
  {
    name: 'Bassi Baoli & Pinjore Foothill Stepwells',
    slug: 'bassi-baoli-pinjore-stepwells',
    ...
    images: [
      {
        ...
        caption: 'The stone steps of Bassi Baoli descending to the natural subterranean aquifer in the Shiwalik foothills.',
        credit: 'Hidden India Field Archive',
        license: 'CC-BY-SA 4.0',
        isPrimary: true,
      },
    ...
    images: [
      {
        ...
        caption: 'The stone corridor and cell blocks of the 1847 Dagshai Heritage Jail in the Solan hills.',
        credit: 'Hidden India Field Archive',
        license: 'Editorial Heritage License',
        isPrimary: true,
      },
